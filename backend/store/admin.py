...
from store.models import Product, Tax, Category, Gallery, Specification, Size, Color, Cart, CartOrder, CartOrderItem, Coupon, ProductFaq, Review, Wishlist, Notification
...
class CouponInlineAdmin(admin.TabularInline):
    model = Coupon
...
class CartOrderItemsAdmin(admin.ModelAdmin):
    list_filter = ['oid']
    list_display = ['oid', 'vendor', 'product' ,'qty', 'price', 'sub_total', 'shipping_amount' , 'service_fee', 'tax_fee', 'total' , 'date']
