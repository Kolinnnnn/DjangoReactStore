...
from store.serializers import ProductSerializer, CaregorySerializer, CartSerializer, CartOrderSerializer, CartOrderItemSerializer
...
class CartAPIView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if cart:
            ...
            return Response({'message':'Cart Updated Succesfully'}, status=status.HTTP_200_OK)
            ...
            return Response({'message':'Cart Created Succesfully'}, status=status.HTTP_201_CREATED)
