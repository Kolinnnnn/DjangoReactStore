                        ...
                        <div className="col-lg-8 mb-4 mb-md-0">
                            ...
                            <div className="row border-bottom mb-4" key={index}>
                                ...
                                <div className="d-flex justify-content-center align-items-center">
                                    ...
                                    <button onClick={() => updateCart(c.product.id, c.product.price, c.product.shipping_amount, c.size, c.color)} className='ms-2 btn btn-primary'><i className='fas fa-rotate-right'></i></button>
                                </div>
