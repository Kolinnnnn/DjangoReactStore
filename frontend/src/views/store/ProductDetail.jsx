                                            ...
                                            <div className="col-md-6 mb-4">
                                                ...
                                                {color?.map((c,index) => (   
                                                    <div key={index} className='me-2'>
                                                        ...
                                                        <button className='btn p-3 ms-2 color_button' type='button' onClick={handleColorButtonClick} style={{ background: `${c.color_code}` }}></button>
                                                    </div>
                                                ))}
                                                </div>
                                                <hr />
                            ...
                            <div className="container mt-5">
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <div className="mb-3">
                                            {reviews.map((r,index) => (
                                            <div className="row g-0 border p-2 mb-3" key={index}>
